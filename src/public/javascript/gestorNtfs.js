...
// Guardar Archivo
export function guardarArchivoNtfs(nombreArchivoExistente, nombreArchivoNuevo, tipoArchivo, rutaArchivoExistente) {
...
// Eliminar Archivo
export function eliminarArchivoNtfs(nombreEliminar, tipoEliminar, rutaEliminar) {
