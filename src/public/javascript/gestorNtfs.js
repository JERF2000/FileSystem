...
import { fsNtfs } from './Plantillas/fsNtfs.js';

const sistema = new fsNtfs();

//Crear Archivo
export function crearArchivoNtfs(nombreArchivo, tipoArchivo, pesoArchivo, rutaArchivo) {
...
// Guardar Archivo
export function guardarArchivoNtfs(nombreArchivoExistente, nombreArchivoNuevo, pesoArchivoNuevo, tipoArchivo, rutaArchivoExistente) {
...
// Eliminar Archivo
export function eliminarArchivoNtfs(nombreArchivo, tipoArchivo, rutaArchivo) {
...
// Mover Archivo
export function moverArchivoNtfs(nombreArchivo, tipoArchivo, rutaActual, nuevaRuta) {
...
export function actualizarConfiguracionOSNtfs(almacenamientoTotal, almacenamientoDisponible) {
...
export function guardarConfigNtfs() {
    sistema.configurarFileSystemNTFS();
